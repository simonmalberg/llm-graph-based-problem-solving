...
def core_title_filter(x):
    return core_title_matcher.match(x).group(1) if core_title_matcher.match(x) else x

class ElasticSearch:
    def __init__(self):
        self.client = Elasticsearch(request_timeout=300, hosts="http://localhost:9200")
